...
RPI_REVISION_1 = ["0002", "0003", "0004", "0005", "0006", "0007",
                  "0008", "0009", "000d", "000e", "000f", "0010", "0011", "0012", "0013"]
RPI_REVISION_2 = ["a01041", "a21041"]
RPI_REVISION_3 = ["a02082", "a22082", "9000c1"]
...
def getPiI2CBusNumber():
    ...
    if revision in [2, 3]:
        ...
        raise ValueError(
            "Error occur while getting Pi Revision. Revision:{0}".format(revision))
